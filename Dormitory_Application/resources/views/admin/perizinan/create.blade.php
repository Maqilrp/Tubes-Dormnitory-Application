...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
      <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">Create Data Perizinan</h6>
          <a href="{{ url('admin/perizinan') }}" class="float-right btn btn-success btn-sm " style="margin-top: 2%">View Data</a>
      </div>
      <div class="card-body">
         {{-- validate --}}
        @if ($errors)
        ...
        @endif
          <div class="table-responsive">
                <form action="{{ url('admin/perizinan') }}" method="post" enctype="multipart/form-data">
                  @csrf
                  <table id="" class="table table-bordered table-striped">
                    {{-- id_user --}}
                    <tr>
                      <th>
                        <label for="id_user" class="form-label float-left" >User<span class="text-danger">*</span></label>
                      </th>
                      <td>
                        <div class="form-floating mb-1">
                            <input type="text" name="id_user" id="#" class="form-control" placeholder="id_user">
                        </div>
                    </td>
                    </tr>
                    {{-- no kamar --}}
