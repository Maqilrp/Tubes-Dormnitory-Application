            ...
            <div class="content" style="margin-top:4%;">
                ...
                <div style=" height:20%; width:85%; margin-left:10%; padding:20px">
                    {{-- <div style="text-align: right">
                        <a href="paket/pengaduan_paket" class="btn btn-primary">Pengaduan Paket</a>
                    </div> --}}
                    {{-- header --}}
                    <h1 >Pengaduan Paket</h1>
                    <hr>
                    {{-- end header --}}

                    <form action="{{url('/laundry/pengaduan_paket/create/'. $user->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        ...
                        <div style="display: flex; justify-content:space-between; margin-top:5%">
                            <div style="text-align: left;">
                                <a href="{{url('/paket/'. $user->id)}}" class="btn btn-danger">Kembali</a>
                            </div>
                            <div style="text-align: right;">
