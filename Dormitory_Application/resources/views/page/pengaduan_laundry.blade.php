            ...
            <div class="content" style="margin-top:4%;">
                ...
                <div style=" height:20%; width:85%; margin-left:10%; padding:20px">
                    {{-- <div style="text-align: right">
                        <a href="paket/pengaduan_paket" class="btn btn-primary">Pengaduan Laundry</a>
                    </div> --}}
                    {{-- header --}}
                    <h1 >Pengaduan Laundry</h1>
                    <hr>
                    {{-- end header --}}

                    <form action="{{url('/laundry/pengaduan_laundry/create/'. $user->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        ...
                        <div class="form-floating">
                            <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" name="permasalahan"></textarea>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Ex : Nama Lengkap">
                        </div> --}}
                        {{-- end nama input --}
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Ex : 081-xxxx-xxxx">
                        </div> --}}
                        ...
                        <div style="display: flex; justify-content:space-between; margin-top:5%">
                            <div style="text-align: left;">
                                <a href="{{url('/laundry/'. $user->id)}}" class="btn btn-danger">Kembali</a>
                            </div>
                            <div style="text-align: right;">
