            ...
            <div class="bg-form" style="height:20%; width:45%; margin-left:30%; background-color:#EEEFF4; border-radius:20px;">
                ...
                <div style=" height:20%; width:85%; margin-left:10%; padding:20px">
                    ...
                    {{-- end header --}}
                        ...
                        <form action="{{url('/listrik/create/'. $user->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                        ...
                        {{-- Nominal Pembelian select --}}
                        <label for="exampleInputPassword1" class="form-label" style="margin-top: 4%">Nominal Pembelian</label>
                        <div class="input-group" >
                            <span class="input-group-text"><i class="fa-solid fa-bolt"></i></span>
                            <select class="form-select" aria-label="Default select example" style="" name="nominal_pembelian">
                                <option selected>Nominal Pembelian</option>
